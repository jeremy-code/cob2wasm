...
#define  COB_SOURCE_FILE		"examples/hello_world.cbl"
#define  COB_PACKAGE_VERSION		"2.2"
#define  COB_PATCH_LEVEL		0
#define  COB_MODULE_FORMATTED_DATE	"Jul 09 2023 02:41:47"
#define  COB_MODULE_DATE		20230709
#define  COB_MODULE_TIME		24147

/* Global variables */
#include "examples/hello_world.c.h"

/* Function prototypes */

int		HELLO__WORLD (void);
...
HELLO__WORLD_ (const int entry)
{
  ...
  #include "examples/hello_world.c.l.h"
  ...
  /* Line: 5         : Entry     HELLO-WORLD             : examples/hello_world.cbl */
  l_2:;

  /* Line: 5         : DISPLAY            : examples/hello_world.cbl */
  cob_display (0, 1, 1, &c_1);

  /* Line: 6         : STOP RUN           : examples/hello_world.cbl */
  cob_stop_run (b_2);
